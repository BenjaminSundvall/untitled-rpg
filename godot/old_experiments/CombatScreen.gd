...
var action_queue : Array[OldAction] = []
var auto_combo : bool = false

const ActionLabel : PackedScene = preload("res://old_experiments/ActionLabel.tscn")
...
var action_1 : OldAction
var action_2 : OldAction
var action_3 : OldAction
var action_4 : OldAction

func _ready() -> void:
	$ChargeBar.max_value = max_charge
	$ActionQueue.columns = max_charge
	
	action_1 = load("res://old_experiments/actions/StrikeAction.gd").new()
	action_2 = load("res://old_experiments/actions/BlockAction.gd").new()
	action_3 = load("res://old_experiments/actions/HealAction.gd").new()
	action_4 = load("res://old_experiments/actions/FireballAction.gd").new()
...
func queue_action(action : OldAction) -> void:
